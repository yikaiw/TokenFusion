...
data_dir = '/mnt/beegfs/ssd_pool/docker/user/hadoop-automl/yikai/upload/taskonomy-sample-model-1'  # 'Modify data path'
...
l1_avg_losses, l2_avg_losses, fids, kids = evaluate(G, epoch=0, training=True)
